...
static long partition(SliceHeader* s, long low, long high, int(*cmp)(const void*, const void*)) {
...
static void quick_sort_start(SliceHeader* s, long low, long high, int(*cmp)(const void*, const void*)) {
    if (low < high) {
...
void slice_quick_sort(SliceHeader* slicePtr, int(*cmp)(const void*, const void*)) {
