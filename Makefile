...
SRCS = main.c internal/render/render.c internal/render/shaders.c internal/window/window.c internal/veishik/veishik.c internal/objparser/parser.c internal/slice/slice.c
OBJS = $(SRCS:.c=.o)
